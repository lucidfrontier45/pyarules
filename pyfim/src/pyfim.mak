...
#-----------------------------------------------------------------------
!IFNDEF PYDIR
PYDIR    = "C:\Program Files\Python-2.7.6"
!ENDIF
THISDIR  = ..\..\pyfim\src
UTILDIR  = ..\..\util\src
MATHDIR  = ..\..\math\src
...
LIBS     = /LIBPATH:$(PYDIR)\libs /LIBPATH:$(PYDIR)\PCBuild
...
OBJS     = arrays.obj memsys.obj idmap.obj random.obj \
           ...
           pfxtree.obj pattree.obj ista.obj accretion.obj pyfim.obj
PRGS     = fim.pyd
...
random.obj:   $(UTILDIR)\random.c pyfim.mak
