...
such a weight, is has to be invoked with the option -w:
  sam -w test3.tab test3.out

The files test4.tab to test6.tab are in formats that may be common,
but which cannot be processed directly with the sam program.
...
numbers or column names into a format appropriate for the sam
...
of the sam program are written to standard error.
