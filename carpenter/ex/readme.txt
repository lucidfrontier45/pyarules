...
needed by the carpenter program.
...
but which cannot be processed directly with the carpenter program.
...
numbers or column names into a format appropriate for the carpenter
...
of the carpenter program are written to standard error.
